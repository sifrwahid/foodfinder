...
<title>Healthy Affordable Food For All: DC Food Finder</title>
...
<div id="mainbox" style="width:960px; padding:5px;margin:10px;align:left;">
  <div style="height: 40px; float: right; text-align: right; font-size: 18px;">
    <b><a href="index.php" alt="English Translation of this Page">English</a> - <a href="index2.php" alt="Spanish Translation of this page">Espa&ntilde;ol</a></b>
  </div>

<table cellpadding="0" cellspacing="0" width="700">
<tr>
<td width="230"><img src="logo.jpg" width="180" align="left" 
style="margin-left:10px;"></td>
<td valign="center" width="600">
<div class="pagetitle">
Welcome to the DC Food Finder:<br \>
An Interactive Map of Food Resources in DC
</div>
<div class="subtitle">Project of <a href="about.html" target="_blank">Healthy Affordable Food For All</a></div>

<div class="getstarted">Get Started Now:</div>
<div class="getstarted_help">
  * Simply click the box next to the resource you're looking for and type an address in the search bar. 
</div>
</td>
<td>
</td>
...
<td width="220">
    ...
    <td style="font-weight:bold;" nowrap>Select Resources</td>
    </tr></table>
</td>
<td width="400">
    ...
    <td>
    <div class="enter_address">Enter an Address to Find Nearest Food Options</div>
    ...
    (e.g. 738 7th st se, washington dc; ward 8; etc.)
    </div>
    <div id="error"></div>
    </td>
    </tr></table>
...
<td width="300" valign="bottom">
 <div style="font-weight:bold;font-size:14px;margin-bottom:10px;margin-left:10px;width:300px;visibility:hidden;" id="printLink"> 
    <img src="xmag.png" hspace="2" style="vertical-align:middle;"><span id="count"></span>&nbsp;Resources Found <a href="#" onclick="javascript:openlist(); return false;">(print list)</a>
 </div>
</td>
</tr></table>
...
<td valign="top" width="400">
    <div id="map" style="width: 400px; height: 400px;">
      <div style="margin-left:200px;margin-top:200px;">loading...</div>
    </div>
	...
	<td><div class="lowerLink"><a href="about.html">About HAFA</a></div></td>
	<td width="20" align="left"><a href="mailto:info@dcfoodfinder.org"><img src="icon_email.jpg" border=0 width=20></td>
	<td><div class="lowerLink"><a href="mailto:info@dcfoodfinder.org">Contact</a></div></td>
...
style="text-decoration:none;">&lt&lt;&lt; PREV</a>
	 </div>
	 </td>
...
style="text-decoration:none;">NEXT &gt;&gt;&gt;</a>
    ...
    <!-- the marker list gets placed here by the foodfinder.js -->
...
<div style="margin-top:5px;">
  <p>Assistance is also available through the <strong>Capital Area Food Bank Hunger Lifeline</strong> at <strong>202-644-9807</strong>.
</p>

</div>
<div style="margin-top:5px;">
<p><span class="copyright">Powered by <a href="http://www.socialcompact.org">Social Compact, Inc.</a> &copy; 2008</span></p>
...
hspace="10"></a>
<!-- OLD: <a href="http://the7thstreetgarden.squarespace.com/" target="_blank">
  <img src="logos/seventhstgarden.jpg" height="50" border="0" hspace="10">
</a> -->
<a href="http://commongoodcityfarm.org/" target="_blank">
  <img src="logos/commongood_logo_small.png" height="52" border="0" hspace="10">
</a>
<a href="http://www.socialcompact.org" target="_blank">
  <img src="logos/socialcompact.gif" height="51" border="0" 
hspace="10"></a>
